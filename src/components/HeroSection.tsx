...
const HeroSection: React.FC = () => {
  return (
    <section className={styles.hero} id="hero">
      ...
      {/* corner tag */}
      <div className={styles.cornerTag}>VOL.1 ★ SPECIAL EDITION</div>

      {/* price sticker */}
      <div className={styles.priceSticker}>
        <span className={styles.priceLabel}>ONLY</span>
        <span className={styles.priceVal}>♥1</span>
      </div>

      {/* floating action words */}
      <span className={styles.aw} style={{ top: '12%', left: '4%', fontSize: 'clamp(1.5rem,4vw,3rem)', color: 'var(--red)', '--r': '-13deg', animationDuration: '2.8s' } as React.CSSProperties}>LOVE!</span>
      <span className={styles.aw} style={{ bottom: '28%', left: '2%', fontSize: 'clamp(1rem,2.5vw,1.9rem)', color: 'var(--blue)', '--r': '9deg', animationDuration: '3.2s', animationDelay: '.5s' } as React.CSSProperties}>POW~</span>
      <span className={styles.aw} style={{ top: '20%', right: '53%', fontSize: 'clamp(1.2rem,3vw,2.5rem)', color: 'var(--red)', '--r': '-6deg', animationDuration: '2.5s', animationDelay: '1s', zIndex: 16 } as React.CSSProperties}>ZOOM!</span>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.left}>
          ...
          <span className={styles.chLabel}>★ CHAPTER 01 — You, In Every Panel ★</span>

          <h1 className={styles.title}>
            THE<br /><em>BEGINNING</em><br />OF US
          </h1>

          <p className={styles.subtitle}>
            A manga made with all my heart<br />
            just for the most incredible person in my world.
          </p>

          <div className={styles.bubble}>
            <p>"Every page of my life got better the moment you appeared in it." ★</p>
          </div>
        </div>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.heartWrap}>
            ...
            <div className={styles.doki}>★&nbsp;PIKO&nbsp;PIKO&nbsp;LOVE&nbsp;★</div>
          </div>
        </div>
      </div>
