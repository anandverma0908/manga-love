    ...
    <section className={styles.section} id="ending">
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.left}>
          ...
          <div
            ref={heartRef}
            className={`${styles.heartAnim} sr`}
            style={{ transitionDelay: "0.28s" }}
          >
            <svg
              viewBox="0 0 200 160"
              width="min(185px,70vw)"
              height="min(148px,56vw)"
            ...
            >
              ...
              <path
                d="M100,140 C100,140 18,88 18,48 C18,23 36,10 56,10 C73,10 89,21 100,35 C111,21 127,10 144,10 C164,10 182,23 182,48 C182,88 100,140 100,140Z"
                fill="var(--yellow)"
                stroke="#0a0806"
                strokeWidth="4"
              />
